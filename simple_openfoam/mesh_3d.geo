...
Physical Surface("inflow_water") = {1010};
Physical Surface("inflow_air") = {1032};
Physical Surface("top") = {1045};
Physical Surface("bottom") = {1001};
Physical Surface("front_wall") = {1022, 1044};
Physical Surface("back_wall") = {1014, 1036};
Physical Surface("outflow") = {1018, 1040};
