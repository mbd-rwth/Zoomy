...
from gui.gui_mesh import meshes
from gui.gui_model import models
from gui.gui_model_editor import model_editor
from gui.gui_visu_editor import visu_editor
from gui.gui_solver import solvers
from gui.gui_visualization import visu
from gui.gui_elements import MyControls
...
tabs = pn.Tabs(('Mesh', meshes.get_layout()), ('Model', tabs_model),('Simulation', solvers.get_layout()), ('Visualization', tabs_visu))
###################################################################
...
info = pn.state.notifications.info('This GUI is WIP. Many functions are not implemented yet.', duration=0)
