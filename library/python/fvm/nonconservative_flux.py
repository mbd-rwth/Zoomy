...
def segmentpath(integration_order=3, scheme='rusanov', backend='jax'):
    ...
    # @jax.jit
    def rusanov(Qi, Qj, Qauxi, Qauxj, parameters, normal, Vi, Vj, Vij, dt, model):
        ...
        def rusanov_batched(Qi, Qj,
            ...
            Dp, Dm = jax.vmap(_rusanov_single,
                            in_axes=(1, 1,   # Qi , Qj
                                    1, 1,   # Qauxi, Qauxj
                                    1,      # normal
        ...
        Dp, Dm = rusanov_batched(Qi, Qj, Qauxi, Qauxj, normal, Vi, Vj, Vij)
        return Dp, Dm,  False
