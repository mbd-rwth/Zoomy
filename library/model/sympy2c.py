...
from sympy.tensor.array import ImmutableDenseNDimArray as Array
import sympy as sym
import os
...
__doc__ = (
    "Converts sympy expressions into autogenerated code then compiles the code and finally"
...
if __name__ == "__main__":
    ...
    y = sym.MatrixSymbol("y", 2, 1)

    fun = a * b * c * d
    anotherfun = Matrix([[a * b, c * d], [a + d, d * d]])
    aanotherfun = [[x[0], x[1]], [y[0], y[1]]]
    aaanotherfun = Array([[[x[0], x[1]], [y[0], y[1]]], [[x[0], x[1]], [y[0], y[1]]]])
    expression_name_tuples = [
        ("fun", fun, [a, c, d, b]),
        ("anotherfun", anotherfun, [a, b, c, d]),
        ("aanotherfun", aanotherfun, [x, y]),
    ]
    #   ('aaanotherfun', aaanotherfun, [x, y])]
    ...
    from temp.temp import fun_c, anotherfun_c, aanotherfun_c

    # from temp.temp import fun_c, anotherfun_c, aanotherfun_c, aaanotherfun_c
    print(fun_c(1, 2, 3, 4))
    print(anotherfun_c(1, 2, 3, 4))
    vin = np.linspace(1, 2, 2, dtype=float).reshape((2, 1))
    print(aanotherfun_c(vin, 2 * vin))
    # print(aaanotherfun_c(vin, 2*vin))
