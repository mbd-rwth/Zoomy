import os
from sympy import symbols, Matrix, diff, exp, I, linear_eq_to_matrix, pprint, solve , Eq, Float, Rational, zeros, simplify, nsimplify, pprint, latex,  symbols, Function, together, Symbol
