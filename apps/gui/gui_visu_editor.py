...
import apps.gui.test as test_code
from apps.gui.docstring_crawler import get_class_code
from apps.gui.gui_elements import MyBasicOrganizer, MyOrganizer
from library.model.model import ShallowWater
from apps.gui.gui_pyvista import create_pyvista_panel
...
controls = pn.Column('# Visualization controls', contr)
